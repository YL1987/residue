...
import com.test.myapplication.view.dialog.CustomProgressDialog;
...
/**
 * 作者：yangyouqiao on 2017/9/22 09:59
 * 功能：
 */

public abstract class BaseAct extends AutoLayoutActivity implements View.OnClickListener, BaseImpl, LifecycleObserver {
    ...
    /**
     * [初始化控件,在这里处理intent,设置adapter,处理缓存等]
     */
